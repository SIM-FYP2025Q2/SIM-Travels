...
#     address: Annotated[str, "Address/Name of the Place"],
...
#         address: Address/Name of the Place
...
#     # Room Quantity should be equal to number of adults
#     if roomQuantity > occupants:
#         roomQuantity = occupants
    
#     api_call_success = False
#     response = None
#     logging.info(f"Attempting to find hotels by city code: {cityCode}")
#     try:
...
#         logging.info(f"Could not find hotels by city code, attempting to find by address: {address}")
#         try:
