 ...
 * and upserting them into a Pinecone vector database. It bridges the gap
 * between the application's relational database and the vector database for AI-powered search.
 */
class VectorRepository
{
    /**
